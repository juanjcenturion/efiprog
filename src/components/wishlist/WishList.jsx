    ...
    return (
        <div className="col-span-9 space-y-4">
            ...
            <div className="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                ...
                <div className="w-1/3">
                    <h2 className="text-gray-800 text-xl font-medium uppercase">SSD Kingston - 240GB - A400</h2>
                    <p className="text-gray-500 text-sm">Disponibilidad: <span className="text-green-600">En Stock</span></p>
                </div>
                <div className="text-primary text-lg font-semibold">$20.800</div>
                <a href="#"
                    className="px-6 py-2 text-center text-sm text-white bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition uppercase font-roboto font-medium">add
                    to cart</a>
            ...
            <div className="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                ...
                <div className="w-1/3">
                    ...
                    <p className="text-gray-500 text-sm">Disponibilidad: <span className="text-red-600">Fuera de Stock</span></p>
                </div>
