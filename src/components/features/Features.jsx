    ...
    return (
        ...
        <div className="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div className="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="src/assets/images/icons/delivery.gif" alt="Delivery" className="w-12 h-12 object-contain "/>
                <div>
            ...
            <div className="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="src/assets/images/icons/reembolso.gif" alt="Delivery" className="w-12 h-12 object-contain"/>
                <div>
            ...
            <div className="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="src/assets/images/icons/soporte.gif" alt="Delivery" className="w-12 h-12 object-contain"/>
                <div>
